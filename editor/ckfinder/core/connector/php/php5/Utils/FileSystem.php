...
class CKFinder_Connector_Utils_FileSystem
{
  ...
  'Û' => 'U', 'Þ' => 'Th', 'Ð' => 'Dh', 'Æ' => 'Ae', 'Ĕ' => 'E',
    ...
    public static function secureFileName($fileName)
    {
      ...
      return remove_special_char($fileName);
    }
    ...
    public static function autoRename( $filePath, $fileName )
    {
      ...
      while (true)
      {
        ...
        if ( file_exists($sFilePath) ){
          $iCounter++;
          $fileName = CKFinder_Connector_Utils_FileSystem::getFileNameWithoutExtension($sFileNameOrginal, false) . "_" . $iCounter . "." .CKFinder_Connector_Utils_FileSystem::getExtension($sFileNameOrginal, false);
        }
        else
        {
          break;
