...
$email = $Member['email'];
$user_folder = @ereg_replace("[^a-zA-Z0-9_]", "_",$email);
...
$config['LicenseName'] = 'HanhNguyen';
$config['LicenseKey'] = '5HAB8XC2EPKEBHBPCG8LE4XKXQ455KXU';
...
*/
$baseUrl = base_url().'/uploads/'.$user_folder.'/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = ROOT_PATH.'uploads/'.$user_folder.'/'; 
//resolveUrl($baseUrl);
